      ...
      <Card className="p-6">
        <div className="space-y-4">
          <div className="text-center">
            <h3 className="text-lg font-semibold">Ваш профиль навыков</h3>
            <p className="text-sm text-muted-foreground">
              Отслеживайте ваш прогресс к цели
            </p>
          </div>
          ...
          {showLegend && (
            <div className="flex flex-wrap gap-4 justify-center text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>Текущие навыки</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded-full bg-indigo-500 opacity-50" />
                <span>Целевой профиль</span>
              </div>
              {previewSkills && (
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full bg-green-500" />
                  <span>С выбранным курсом</span>
                </div>
              )}
            </div>
          )}
