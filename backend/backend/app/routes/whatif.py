...
def analyze_goal_change(
    ...
    new_goal_roadmap = gemini_service.generate_roadmap_options(
        goal=new_goal,
...
def compare_career_paths(
    ...
    current_roadmap = gemini_service.generate_roadmap_options(
    ...
    for goal in alternative_goals:
        roadmap = gemini_service.generate_roadmap_options(
            goal=goal,
            available_courses=courses_data,
            completed_skills=list(current_skills)
        )
